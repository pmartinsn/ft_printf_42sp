...
/*   Updated: 2020/11/21 12:31:22 by pmartins         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//	int		h = 4200;
	...
	char	*u = "-0";
	       ...
	       return_printf = printf("beging here1%*.*u,2 %*.*x,3 %*.*X,4 %*.*u,5 %*.*x,6 %*.*X,7 %*.*u,8 %*.*x,9 %*.*X, %*.*u, %*.*x, %*.*X, %*.*u, %*.*x, %*.*X, %*.*u, %*.*x, %*.*X\n", a, b, i, a, b, i, a, b, i, a, b, j, a, b, j, a, b, j, a, b, k, a, b, k, a, b, k, a, b, l, a, b, l, a, b, l, a, b, m, a, b, m, a, b, m, a, b, c, a, b, c, a, b, c);
	 return_ft_printf = ft_printf("beging here1%*.*u,2 %*.*x,3 %*.*X,4 %*.*u,5 %*.*x,6 %*.*X,7 %*.*u,8 %*.*x,9 %*.*X, %*.*u, %*.*x, %*.*X, %*.*u, %*.*x, %*.*X, %*.*u, %*.*x, %*.*X\n", a, b, i, a, b, i, a, b, i, a, b, j, a, b, j, a, b, j, a, b, k, a, b, k, a, b, k, a, b, l, a, b, l, a, b, l, a, b, m, a, b, m, a, b, m, a, b, c, a, b, c, a, b, c);
